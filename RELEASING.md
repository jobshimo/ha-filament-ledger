...
only when there is none. `brand/icon.png` (256×256) and `brand/icon@2x.png` (512×512) are here,
generated by `brand/make_icons.py` from the panel's own palette — so HACS is satisfied by the
